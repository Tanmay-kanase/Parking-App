...
export default function SearchParkings() {
  ...
  if (loading)
    return (
      <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-gray-100/75 dark:bg-gray-900/75 backdrop-blur-sm transition-opacity duration-300">
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-10 transition-colors duration-300">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="relative flex-grow">
            ...
            <input
              ...
              className="w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 rounded-xl py-4 pl-12 pr-4 focus:outline-none focus:border-yellow-500 focus:ring-2 focus:ring-yellow-500/50 transition-all text-lg shadow-sm dark:shadow-inner placeholder-gray-400 dark:placeholder-gray-500"
            />
              ...
              <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl z-50 max-h-72 overflow-y-auto">
                {suggestions.map((item) => (
                  <div
                    ...
                    className="px-4 py-3 hover:bg-yellow-50 dark:hover:bg-gray-700 cursor-pointer border-b border-gray-100 dark:border-gray-700 last:border-b-0"
                  >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {!searchQuery ? (
            <div className="col-span-full flex flex-col items-center justify-center py-16 bg-white/50 dark:bg-gray-800/50 rounded-xl border border-gray-300 dark:border-gray-700 border-dashed">
              <FaSearch className="text-gray-400 dark:text-gray-600 text-5xl mb-4" />
              ...
              return (
                ...
                >
                  <div>
                    ...
                    <p className="text-gray-800 dark:text-gray-300 text-lg font-semibold mb-4 border-b border-gray-200 dark:border-gray-700 pb-2">
                      Total Slots:{" "}
                    ...
                    <div className="mb-4">
                      <p className="block text-gray-800 dark:text-gray-300 font-semibold mb-2">
                        Available Parking:
                      </p>
                            ...
                            <div
                              ...
                              ${
                                v.slots === 0
                                  ...
                                  : "bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 shadow-sm dark:shadow-none"
                              }`}
                            >
                              <Icon
                                className={`${
                    ...
                    <div className="grid grid-cols-2 gap-2 mb-4">
                      <div className="flex items-center justify-center gap-2 border border-gray-200 dark:border-gray-700 p-2 rounded-lg bg-gray-50 dark:bg-gray-800">
            ...
            <div className="col-span-full flex flex-col items-center justify-center py-16 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
              <FaMapMarkerAlt className="text-gray-400 dark:text-gray-600 text-5xl mb-4" />
              <p className="text-gray-900 dark:text-gray-300 text-xl font-semibold">
